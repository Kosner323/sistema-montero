...
def test_encryption_consistency():
    ...
    try:
        ...
        decrypted1 = decrypt_text(encrypted1)
        decrypted2 = decrypt_text(encrypted2)
...
def test_encryption_key_persistence():
    ...
    try:
        ...
        # Crear una nueva instancia (simula reinicio)
...
def test_empty_and_none():
    ...
    try:
        # Caso 1: String vacío
        print("\nCaso 1: String vacío")
        encrypted_empty = encrypt_text("")
        decrypted_empty = decrypt_text(encrypted_empty)
        print(f"  Original: ''")
