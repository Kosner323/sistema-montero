        ...
        for credencial in credenciales:
            try:
                ...
                contrasena_encriptada = (
                    is_encrypted(contrasena) if contrasena else False
                )
                ...
                nuevo_usuario = (
                    ...
                    if usuario and not usuario_encriptado
                    else usuario
                )
                nueva_contrasena = (
                    encrypt_text(contrasena)
                    if contrasena and not contrasena_encriptada
                    else contrasena
                )
        ...
        for credencial in credenciales:
            ...
            try:
                ...
                contrasena_desencriptada = (
                    decrypt_text(contrasena) if contrasena else "N/A"
                )
