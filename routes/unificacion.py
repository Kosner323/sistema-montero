    ...
    try:
        ...
        for usuario in usuarios:
            usuarios_list.append({
                'numeroId': usuario[0],
                'nombre': usuario[1],
                'empresa_nit': usuario[2],
                'empresa_nombre': usuario[3]
            })
...
def asignar_empresa_a_usuario():
    ...
    try:
        ...
        cursor.execute(
            "UPDATE usuarios SET empresa_nit = ? WHERE numeroId = ?",
            (empresa_nit, usuario_id)
        )
...
def desasignar_empresa_de_usuario():
    ...
    try:
        ...
        cursor.execute(
            "UPDATE usuarios SET empresa_nit = NULL WHERE numeroId = ?",
            (usuario_id,)
        )
        ...
        return jsonify({
            ...
            "empresa_anterior": {
                "nit": empresa_nit_actual,
                "nombre": empresa_nombre_actual
            }
        }), 200
...
def get_estadisticas():
    ...
    try:
        ...
        logger.info(f"   - Total usuarios: {total_usuarios} ({usuarios_asignados} asignados, {usuarios_sin_asignar} sin asignar)")
        logger.info(f"   - Total empresas: {total_empresas} ({empresas_con_usuarios} con usuarios, {empresas_sin_usuarios} sin usuarios)")
...
def get_module_info():
    ...
    return {
        ...
        "endpoints": [
            ...
            {
                "ruta": "/api/unificacion/asignar",
                "metodo": "POST",
                "descripcion": "Asigna una empresa a un usuario"
            },
            {
                "ruta": "/api/unificacion/desasignar",
                "metodo": "POST",
                "descripcion": "Desasigna la empresa de un usuario"
            },
            {
